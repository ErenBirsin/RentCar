...
import { ChangeDetectionStrategy, Component, computed, inject, input, signal, ViewEncapsulation, AfterViewInit, contentChildren, contentChild, TemplateRef } from '@angular/core';
