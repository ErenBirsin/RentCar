...
internal sealed class BranchGetQueryHandler(IBranchRepository branchRepository, IUserRepository userRepository) : IRequestHandler<BranchGetQuery, Result<BranchDto>>
{
