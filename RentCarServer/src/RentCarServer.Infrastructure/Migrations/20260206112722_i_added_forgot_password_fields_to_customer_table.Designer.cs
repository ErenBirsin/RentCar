...
namespace RentCarServer.Infrastructure.Migrations
{
    ...
    [Migration("20260206112722_i_added_forgot_password_fields_to_customer_table")]
    partial class i_added_forgot_password_fields_to_customer_table
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("RentCarServer.Domain.ProtectionPackage.ProtectionPackage", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uniqueidentifier");
            ...
            modelBuilder.Entity("RentCarServer.Domain.ProtectionPackage.ProtectionPackage", b =>
                {
                    ...
                    b.OwnsOne("RentCarServer.Domain.ProtectionPackage.ValueObjects.IsRecommended", "IsRecommended", b1 =>
                        {
                            b1.Property<Guid>("ProtectionPackageId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsMany("RentCarServer.Domain.ProtectionPackage.ValueObjects.ProtectionCoverage", "Coverages", b1 =>
                        {
                            b1.Property<Guid>("ProtectionPackageId")
                                .HasColumnType("uniqueidentifier");
                    ...
                    b.OwnsOne("RentCarServer.Domain.Reservations.Forms.Form", "DeliveryForm", b1 =>
                        {
                            ...
                            b1.OwnsMany("RentCarServer.Domain.Reservations.Forms.ValueObjects.Supplies", "Supplies", b2 =>
                                {
                                    b2.Property<Guid>("FormReservationId")
                                        .HasColumnType("uniqueidentifier");
